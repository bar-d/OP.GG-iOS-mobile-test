...
final class KDALabel: UILabel {
    ...
    func setupKDAAverage(with summary: Matches.Summary) {
        ...
        let totalDeathsAttribute: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.darkishPink]
    ...
    func setupKDA(with games: Matches.Game) {
        ...
        let deathsAttribute: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.darkishPink]
